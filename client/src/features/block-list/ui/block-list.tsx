...
export const BlockList = ({ className }: { className: string }) => {
  ...
  return (
    <div className={className}>
      ...
      <div className="rounded-xl bg-slate-100/50 px-10 py-6 flex flex-col gap-6 h-[400px] grow overflow-y-auto">
        {isLoader && <UiSpinner className="text-teal-600 w-10 h-10 mx-auto" />}

        {isEmptyText && <div className="text-xl py-1 text-center">List is empty...</div>}
